...
const Header: React.FC<HeaderProps> = ({ isLargeScreen, onToggleSidebar }) => {
  // for translate
  const { t } = useTranslation();
  const dispatch = useDispatch();
  // for trigger logout menu
      ...
      <Toolbar>
        {!isLargeScreen ? (
          <IconButton
            ...
            sx={{ mr: isEn() ? 2 : "inherit", ml: isEn() ? "inherit" : 2 }}
          >
            <MenuIcon />
          </IconButton>
        ) : (
        ...
        <SoftTypography size="lg"> {t("header.welcome")}</SoftTypography>
        ...
        <IconButton color="inherit">
          <Badge
            ...
            sx={{
              "& .MuiBadge-badge": {
                backgroundColor: "#337C96",
                color: "white",
              },
            }}
          >
            <MailIcon sx={{ color: "#337C96" }} />
          </Badge>
        </IconButton>
        <IconButton color="inherit">
          <Badge
          ...
          >
            <NotificationsIcon sx={{ color: "#337C96" }} />
          </Badge>
        </IconButton>
